            ...
            <div className="container mt-4 terms">
                <div className="mb-4">
                    ...
                    <ul className="list-unstyled" >
                        ...
                        <li>ReservationKart merely acts as a facilitator to enable the User to book a flight ticket. The contract of service for utilization of the flight is always between the User and the concerned airline.</li>
                        <li>Airlines retain the right to reschedule flight times, route, change or cancel flights or itineraries independent of and without prior intimation to ReservationKart. As a facilitator, ReservationKart has no control or authority over the logistics of the airlines and therefore is not liable for any loss, direct or incidental, that a User may incur due to such change or cancellation of a flight.</li>
                        <li>Different tickets on the same airline may carry different restrictions or include different services and price.</li>
                        <li>The baggage allowance on given fare is as per the terms decided by the airline, and ReservationKart has no role to play in the same. Some of the fares shown in the booking flow are “hand baggage fares” which do not entitle the User for free check-in baggage and therefore the User will be required to pay separately for check-in baggage. The prices for adding check-in baggage to a booking may vary from airline to airline. The User is advised to contact the airlines for detailed costs.</li>
                    </ul>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <ul className="list-unstyled">
                        <li>In the event User does not embark on the onward journey, the entire PNR pertaining to that booking shall be automatically cancelled by the airline. In such a scenario ReservationKart has no control in the said process nor will be obligated to provide alternate bookings to the User. The cancellation penalty in such an event shall be as per the applicable airline rules.</li>
                    </ul>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <ul className="list-unstyled">
                        <li>Refunds will be processed as per the airline fare rules and cancellation policy. Such refunds shall be subject to ReservationKart receiving the same from the airlines. However, the convenience fee paid to ReservationKart paid at the time of booking is a non-refundable fee.</li>
                        <li>All cancellations made directly with the airline need to be intimated to ReservationKart, in order to initiate the process of refund. The processing time for refunds may vary depending on the mode of payment, bank etc. The refund shall be processed after deducting the ReservationKart service fee which is independent of the convenience fee as mentioned above.</li>
                        <li>The refund will be credited to the same account from which the payment was made. For example, if the User used a credit card, ReservationKart will make an appropriate charge reversal to the same credit card; likewise, if the User used a debit card, ReservatinKart will credit the money to the same debit card.</li>
