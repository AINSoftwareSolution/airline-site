...
const Offers = () => {
    ...
    <h2 className="text-center display-5 mb-4 fw-bold">Plan your travel with confidence</h2>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="mb-4">
                ...
                <p>
                    Our friendly agents are available around the clock to assist you with all your booking needs.
                </p>
            </div>
            <div className="mb-4">
                ...
                <p>
                    Need to travel on short notice? We have you covered with unbeatable last-minute deals.
                </p>
            </div>
            <div>
                ...
                <h4>Group Booking</h4>
                <p>
                    Special rates and arrangements for group travel.
                </p>
            </div>
        </div>
        <div className="col-md-6">
            <div className="image-group">
                <Image src={LandingImg} className="img-fluid rounded-image mb-4" alt="Plan 1" />
            </div>
        </div>
    </div>
</section>
